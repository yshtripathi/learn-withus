...
// Cart section
    ...
    Route::get('pages/{slug}', [FrontendController::class, 'getPage'])->name('pages');
    Route::get('instructor', [FrontendController::class, 'getAllInstructor'])->name('instructor');
    Route::get('instructor/{slug}', [FrontendController::class, 'getInstructor'])->name('instructor.details');
...
// User section start
    ...
    // Language Switcher
    Route::get('/change-currency/{currency}', [CurrencyController::class, 'changeCurrency'])->name('change.currency');

    // Contact Us Email
    Route::post('/contact', [ContactController::class, 'sendContact'])->name('contact.send');
    
    Route::get('{slug}', [FrontendController::class, 'getPage'])->name('pages');
