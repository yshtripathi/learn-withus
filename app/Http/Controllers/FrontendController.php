...
class FrontendController extends Controller
{
    ...
    public function productCat(Request $request) {
        ...
        //$categoryID = Category::select('id')->where('slug', $request->slug)->first();
        ...
        if(request()->is('e-shop.loc/product-grids')) {
            return view('frontend.pages.product-grids')->with('products',$products->products)->with('category',$category)->with('recent_products',$recent_products);
        }
        else{
            return view('frontend.pages.product-lists')->with('products',$products->products)->with('category',$category)->with('recent_products',$recent_products);
        }
    ...
    public function productSubCat(Request $request){
        ...
        if(request()->is('e-shop.loc/product-grids')){
            return view('frontend.pages.product-grids')->with('products',$products->sub_products)->with('category',$category)->with('recent_products',$recent_products);
        }
        else{
            return view('frontend.pages.product-lists')->with('products',$products->sub_products)->with('category',$category)->with('recent_products',$recent_products);
        }
    ...
    public function getInstructor(Request $request) {
        ...
        $instructorData = Instructor::getInstructorBySlug($request->slug);

        return view('frontend.pages.instructor-detail')->with('instructor_data', $instructorData);
    }

    public function getAllInstructor(Request $request) {

        $instructorData = Instructor::getAllInstructor();

        return view('frontend.pages.instructor')->with('instructor_data', $instructorData);
    }
